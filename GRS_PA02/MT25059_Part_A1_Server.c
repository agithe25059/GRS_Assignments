/*
 * Roll No: MT25059
 * File: MT25059_Part_A1_Server.c
 * Description: Baseline TCP Server using standard send().
 */
...
void *handle_client(void *arg) {
    ...
    while (1) {
        // MSG_NOSIGNAL prevents crash if client closes connection
...
int main() {
    // IGNORE SIGPIPE to prevent crash
